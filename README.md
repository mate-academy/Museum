...
Check font styles. Use [IBMPlexSans](https://fonts.google.com/specimen/IBM+Plex+Sans?query=ibm), [Montserrat](https://fonts.google.com/specimen/Montserrat?query=mon)
...
13. Replace `<your_account>` with your Github username in the
  [DEMO LINK](https://Anothar.github.io/Museum/).
